...
function GoogleBadge() {
  return (
    <div className="inline-flex items-center gap-2 rounded-lg bg-[hsl(210,40%,12%)]/70 px-2.5 py-2 backdrop-blur-md sm:gap-4 sm:rounded-2xl sm:px-5 sm:py-3">
      {/* Google G */}
      <svg viewBox="0 0 48 48" className="h-6 w-6 flex-shrink-0 sm:h-10 sm:w-10">
      ...
      <div>
        <p className="text-[9px] font-semibold text-[hsl(0,0%,100%)]/80 sm:text-xs">Google Değerlendirme</p>
        <div className="flex items-center gap-1">
          <span className="text-sm font-extrabold text-[hsl(0,0%,100%)] sm:text-xl">4.8</span>
          <div className="flex">
            {[...Array(5)].map((_, i) => (
              <Star key={i} className="h-2.5 w-2.5 fill-[hsl(43,96%,56%)] text-[hsl(43,96%,56%)] sm:h-4 sm:w-4" />
            ))}
          </div>
        </div>
        <p className="text-[8px] text-[hsl(0,0%,100%)]/60 sm:text-[11px]">4.400+ Değerlendirme</p>
      </div>
    </div>
  )
}
